 ...
 */
module.exports = checkLogin = (request, response, next) => {
 ...
 * @returns {Object} Object
 */
module.exports = checkSignUp = (request, response, next) => {
  const {
 ...
 * @returns {Object} Object
 */
module.exports = checkMeal = (request, response, next) => {
  const {
 ...
 * @returns {Object} Object
 */
module.exports =  validatePassword = (request, response, next) => {
 ...
 * @returns {Object} Object
 */
module.exports = validateId = (request, response, next) => {
